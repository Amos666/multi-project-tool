...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'tab.workflow': 'Flow',
        'tab.batch': 'Batch',
        'settings.workbenchTabs': 'Workbench Tabs',
        ...
        'wb.wf.prodConfirm': 'You are about to run this workflow in PRODUCTION (prod) environment. Continue?',
    ...
    zh: {
        ...
        'wb.wf.prodConfirm': '即将在 生产环境 (prod) 执行工作流，确认继续？',
